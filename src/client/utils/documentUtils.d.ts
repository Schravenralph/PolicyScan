 ...
 * ```
 */
export declare const normalizeBronDocument: (doc: BronDocument | CanonicalDocument) => BronDocument;
/**
 ...
 */
export declare const normalizeBronDocuments: (docs: (BronDocument | CanonicalDocument)[]) => BronDocument[];
/**
 ...
 */
export declare const isDocumentReviewed: (doc: CanonicalDocument) => boolean;
/**
 ...
 */
export declare const getDocumentStatus: (doc: CanonicalDocument) => "approved" | "rejected" | "pending";
/**
 ...
 */
export declare const formatDocumentDate: (doc: CanonicalDocument, locale?: string) => string | null;
