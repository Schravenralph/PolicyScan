...
export interface IAdapter {
    ...
    acquire(record: unknown): Promise<unknown>;
    extract(bundle: unknown): Promise<unknown>;
    ...
    persist(draft: CanonicalDocumentDraft, extensions: ExtensionDraft[], ctx: ServiceContext): Promise<unknown>;
}
/**
...
export interface CanonicalDocumentService {
    upsertBySourceId(draft: CanonicalDocumentDraft, ctx: ServiceContext): Promise<unknown>;
    upsertByFingerprint(draft: CanonicalDocumentDraft, ctx: ServiceContext): Promise<unknown>;
    findById(id: string): Promise<unknown | null>;
    findByQuery(filters: DocumentFilters, paging?: PagingParams): Promise<unknown>;
    getDocumentWithExtensions(documentId: string, extensionTypes?: ExtensionType[], ctx?: ServiceContext): Promise<unknown | null>;
    getDocumentsWithExtensions(documentIds: string[], extensionTypes?: ExtensionType[], ctx?: ServiceContext): Promise<unknown[]>;
    getArtifactContent(documentId: string, mimeType?: string): Promise<unknown | null>;
    getArtifactAsString(documentId: string, mimeType?: string, encoding?: BufferEncoding): Promise<unknown | null>;
    getArtifactRefs(documentId: string): Promise<unknown[]>;
    getArtifactRefByMimeType(documentId: string, mimeType: string): Promise<unknown | null>;
    extractFileFromBundle(documentId: string, filename: string, bundleMimeType?: string): Promise<unknown | null>;
    extractFileFromBundleAsString(documentId: string, filename: string, bundleMimeType?: string, encoding?: BufferEncoding): Promise<unknown | null>;
    listBundleFiles(documentId: string, bundleMimeType?: string): Promise<unknown[]>;
    getBundleFilesByFormat(documentId: string, format: string, bundleMimeType?: string): Promise<unknown[]>;
...
export interface CanonicalChunkService {
    upsertChunks(documentId: string, chunks: CanonicalChunkDraft[], ctx: ServiceContext): Promise<unknown>;
    findChunks(documentId: string, paging?: PagingParams): Promise<unknown>;
    semanticRetrieve(queryEmbedding: number[], filters: DocumentFilters, topK: number): Promise<unknown>;
}
/**
...
export interface VectorSearchProvider {
     ...
     */
    upsertEmbedding(chunkId: string, documentId: string, modelId: string, embedding: number[], dims: number): Promise<void>;
    /**
     ...
     */
    search(queryEmbedding: number[], modelId: string, topK: number, filters?: {
        documentIds?: string[];
...
export interface GeoIndexService {
    ...
    queryIntersect(geometryWgs84: unknown, filters: DocumentFilters): Promise<unknown[]>;
    queryWithin(bboxWgs84: number[], filters: DocumentFilters): Promise<unknown[]>;
}
/**
