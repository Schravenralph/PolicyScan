...
import { SteinerTreeAlgorithm, SteinerTreeConfig, SteinerTreeResult, WeightedEdge } from './SteinerTreeAlgorithm.js';
...
/**
 * Steiner Tree Service
 * 
 * Provides Steiner tree algorithm for finding minimum weighted paths
 * connecting key concepts in the knowledge graph. Integrates with
 * GraphTraversalService and HybridScorer for optimal path selection.
 */
export class SteinerTreeService {
    private algorithm: SteinerTreeAlgorithm;
    // private traversalService: GraphTraversalService; // Unused
    // private hybridScorer?: HybridScorer; // Unused
    ...
    constructor(
        ...
        this.algorithm = new SteinerTreeAlgorithm(driver);
